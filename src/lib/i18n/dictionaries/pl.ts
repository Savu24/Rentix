  ...
  panel: {
    ...
    propertiesPage: {
      ...
      form: {
        ...
        sectionPapers: "Dokumenty",
        sectionPapersHint:
          "Numery z papierów lokalu, które przepisuje się potem do umowy.",
    ...
    tenantsPage: {
      ...
      detail: {
        ...
        noSentMessages: "Do tego najemcy nie poszła jeszcze żadna wiadomość.",
        sentMessagesLead: "Ostatnie {count} wysyłek.",
        sendFailed: "Nie dotarło",
        notificationTypes: {
