...
export const uk: Dictionary = {
  ...
  marketing: {
    ...
    pricing: {
      ...
      lead: "Start for free. You pay once the tenancies add up.",
      badge: "MOST POPULAR",
      ...
      plans: [
        {
          ...
          items: [
            ...
            "Rent raised on the date in the tenancy",
            "Email reminders to the tenant",
        ...
        },
        {
          ...
          items: [
            ...
            "Documents emailed to the tenant",
            "Yearly summary",
          ],
          cta: "Choose Start",
        },
  ...
  panel: {
    ...
    propertiesPage: {
      ...
      form: {
        ...
        */
        ...
        sectionPapers: "Documents",
        sectionPapersHint:
          "The numbers from the property paperwork that go into the tenancy agreement.",
    ...
    settings: {
      ...
      numbering: {
        ...
        lead: "How the next documents are numbered. Documents already issued keep their numbers, and the series letters (INV, PF, CHG) are added automatically.",
        saved: "Number format saved.",
        save: "Save",
        presets: {
          "{n}/{m}/{y}": "Number, month, year",
          "{n}/{y}": "Number, year",
          "{y}/{m}/{n}": "Year, month, number",
          "{d}/{m}/{y}/{n}": "Day, month, year, number",
        },
        ...
        problems: {
          empty: "Enter a number format",
          tooLong: "The format can be at most {max} characters",
          badChars: "Outside the symbols only letters, digits, spaces and / - . _ are allowed",
          unknownToken: "Unknown symbol in braces. Allowed: {n}, {d}, {m}, {y}",
          noSequence: "The format needs {n} — without a sequence number documents would collide",
          manySequences: "{n} can appear only once",
          adjacentTokens: "Separate the symbols, e.g. {n}/{m} instead of {n}{m}",
          monthWithoutYear: "A month without a year would repeat numbers every year — add {y}",
          dayWithoutMonth: "A day without a month does not make a date — add {m}",
        },
      },
